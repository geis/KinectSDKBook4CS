...
Partial Public Class MainWindow
    ...
    Private Sub StartKinect(ByVal kinect As KinectSensor)
        ...
        AddHandler kinect.AudioSource.BeamAngleChanged, AddressOf AudioSource_BeamAngleChanged
        ...
        Dim _thread As Thread = New Thread(
                                New ThreadStart(Sub()
                                                    ...
                                                    ' 音声の入力を開始する
                                                    Using _stream As Stream = kinect.AudioSource.Start()
                                                        Do While (IsContinue)
                                                            ' 音声を入力し、スピーカーに出力する
        ...
        Me.sliderTiltAngle.Maximum = kinect.MaxElevationAngle
        Me.sliderTiltAngle.Minimum = kinect.MinElevationAngle
        Me.sliderTiltAngle.Value = kinect.ElevationAngle
    End Sub
    ...
    Private Sub StopKinect(ByVal kinect As KinectSensor)
        If kinect IsNot Nothing Then
            If kinect.IsRunning Then
                ...
                ' 音源方向更新イベントを削除する
                RemoveHandler kinect.AudioSource.BeamAngleChanged, AddressOf AudioSource_BeamAngleChanged
                RemoveHandler kinect.AudioSource.SoundSourceAngleChanged, AddressOf AudioSource_SoundSourceAngleChanged
